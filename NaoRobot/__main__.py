...
PM_START_TEXT = """
[✨](https://telegra.ph/file/9357e7420a924d4581903.jpg) ʜᴇʟʟᴏ  ᴍʏ ɴᴀᴍᴇ ɪs ᴋᴇʏᴢɪo
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴋᴇʏᴢio ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url=f"https://t.me/{BOT_USERNAME}?startgroup=true"),
    ],
    [
...
keyzia_IMG = "https://telegra.ph/file/93b07a50496c85afbdd51.jpg"
...
def nao_about_callback(update, context):
    ...
    if query.data == "nao_":
        query.message.edit_text(
            text=""" 💡 I'm *Keyzia*, a powerful group management bot built to help you manage your group easily.
